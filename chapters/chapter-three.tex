...
After descending through a stable, a church, a mill, and a cave, Blake says:

\poembox[2.25em]{%
	\dots we beheld the infinite abyss, fiery as the smoke \\
	of a burning city\dots
}
When they have returned to the real world, Blake says:
...
\poembox[2.25em]{%
	\enquote{We impose on one another, \& it is but lost time \\
...
\quotebox[2.25em]{%
	\noindent \enquote{Think of a white cloud as being holy, you cannot love it, but
...
\quotebox[2.25em]{%
	\noindent \enquote{The worshop of God is, honouring His gifts in other men, each according to
...
\poembox[2.25em]{O Earth, O Earth, return!}
...
\poembox[2.25em]{Turn away no more}
...
Another of Blake's \enquote{Proverbs of Hell}:
